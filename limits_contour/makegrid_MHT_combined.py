...
cardmakerpath='./cardmaker_MHT_combined.py'
...
for iPoint in range(len(points)):
    ...
    os.system(cardmakerpath+' -s '+yield_19_2fb+' -t '+yield2_19_2fb+' -t2 '+yield3_19_2fb+' -t3 '+yield4_19_2fb+' -t4 '+yield5_19_2fb+' -t5 '+yield6_19_2fb+' -t6 '+yield7_19_2fb+' -t7 '+yield8_19_2fb+' -t8 '+yield8_19_2fb+' -n '+xvarname+xvarval+yvarname+yvarval+' -b True')
